<div class="container">
    ...
    <a href="<?=base_url_admin?>/category/add"><button class="btn"
...
function editBtn(btn) {
    ...
    window.location.href = "<?=base_url_admin?>/category/update?id=" + `${deletedId}`;
}
...
function deleteBtn(btn) {
    ...
    if (xoa) {
        ...
        xhr.open('POST', '<?=base_url_admin?>/category/delete', true);
